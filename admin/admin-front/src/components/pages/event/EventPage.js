...
import { selectEventList, selectIsCreateEnable } from "../../../store/selectors/events";
            ...
            <div>
                <Spin spinning={ eventsLoading && events.length === 0 }>
                    <div className={ "event-page__button-menu" }>
                        ...
                        <DeviceSelector style={ { width: 430 } } afterSelect={ this.props.loadEvents }/>
                    </div>
                    <Divider orientation={ "left" }>Список ссылок с мероприятиями</Divider>
                    <div style={ {
                        overflow: 'auto',
                        height:   444
                    } }
